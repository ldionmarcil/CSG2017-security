        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="intro-message">
              <h1><i>What Time Is It?</i> As A Service</h1>
              <h3>We're making time more accessible, for a better world</h3>
              ...
              <ul class="list-inline intro-social-buttons">
                ...
                <li>
                  <a href="/quote/" class="btn btn-default btn-lg"><i class="fa fa-check-square-o fa-fw"></i> <span class="network-name">Request a quote</span></a>
                </li>
              </ul>
            </div>
          </div>
      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-5 col-sm-6">
            ...
            <h2 class="section-heading">What do we do at WTIIAAS?<br>More than just profit!</h2>
